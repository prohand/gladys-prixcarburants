 ...
 * @param {object} gladys SDK instance
 * @param {{ config: object, store: object, history?: object, sceneEvents?: object }} context
 */
export async function refreshPrices(gladys, { config, store, history, sceneEvents = null }) {
